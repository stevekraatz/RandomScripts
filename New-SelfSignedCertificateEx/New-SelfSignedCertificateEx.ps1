...
# Example command to run after installing the PS Module below:
#
# New-SelfsignedCertificateEx -Subject "CN=ExampleName" -KeySpec "Exchange" -FriendlyName "ExampleFriendlyName" -SignatureAlgorithm "sha256" -NotAfter $([datetime]::now.AddYears(1)) -StoreLocation "LocalMachine" -Exportable
#
